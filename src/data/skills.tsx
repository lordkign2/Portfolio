...
export const skills: Skill[] = [
    ...
    { label: "Google Analytics", icon: <SiGoogleanalytics size={40} className="text-yellow-500" />, level: 90, category: 'Business' },
    { label: "Google Ads", icon: <SiGoogleads size={40} className="text-blue-500" />, level: 85, category: 'Business' },
    { label: "SEO", icon: <TbSeo size={40} className="text-green-500" />, level: 92, category: 'Business' },
    { label: "Conversion Optimization", icon: <TargetIcon size={40} className="text-red-500" />, level: 88, category: 'Business' },
];
