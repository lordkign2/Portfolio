          ...
          {projects.map((proj, index) => (
            ...
            >
              <a href={proj.href} target="_blank" rel="noopener noreferrer">
                <SpotlightCard
                  className="h-[450px] custom-spotlight-card cursor-target bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border border-white/30 dark:border-gray-700/50 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl"
