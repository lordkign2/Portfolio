...
import { trackContactForm, trackSocialClick } from '@/lib/conversion-tracking';
    ...
    emailjs
      ...
      .then(
        () => {
          ...
          // Track successful form submission with enhanced analytics
          trackContactForm(formData, true);
          analytics.trackEvent({
          ...
          if (typeof window !== 'undefined' && window.gtag && process.env.NEXT_PUBLIC_GOOGLE_ADS_CONVERSION_LABEL) {
        ...
        (error) => {
          ...
          trackContactForm(formData, false);
          analytics.trackEvent({
            ...
            <div className="mt-10">
              ...
              <div className="flex flex-wrap gap-6">
                <a
                  ...
                  aria-label="GitHub"
                  onClick={() => trackSocialClick('GitHub', 'https://github.com/lordkign2')}
                >
                ...
                <a
                  ...
                  className="text-blue-200 hover:text-white transition-colors"
                  aria-label="LinkedIn"
                  onClick={() => trackSocialClick('LinkedIn', 'https://www.linkedin.com/in/umeh-kingsley-43a322369')}
                >
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="text-blue-200 hover:text-white transition-colors"
                  aria-label="Facebook"
                  onClick={() => trackSocialClick('Facebook', 'https://www.facebook.com/share/1D7ew99sD8')}
                >
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  onClick={() => trackSocialClick('Instagram', 'https://www.instagram.com/lordkign?igsh=NHhiYmdzNzZ1eHIy')}
                >
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-8 pt-8 border-t border-gray-700 w-full">
                ...
                <div className="flex flex-wrap gap-4">
                  <a
                    href="/projects"
                    className="cursor-target rtext-blue-300 hover:text-blue-100 transition-colors duration-300 font-medium underline decoration-blue-300 hover:decoration-blue-100"
